...
public class MyList {
    ...
    public static MyList iterSquareList(MyList list) {
		...
		MyList head = new MyList(list.value * list.value, null);
		MyList item = head;
        list = list.next;
        while (list != null) {
            item.next = new MyList(list.value * list.value, null);
            list = list.next;
            item = item.next;
        }
		return head;
    ...
    public static MyList iterCatList(MyList listA, MyList listB) {
        ...
        MyList head = new MyList(listA.value, null);
        MyList item = head;
        while (listA.next != null) {
            item.next = new MyList(listA.next.value, null);
            listA = listA.next;
            item = item.next;
        }
        item.next = listB;
