package com.aruix.impl.lab.week9.ARDequeIterator;
...
public class ARDequeIterator<T> {
     ...
     * 
     * @return true if next() will return another item, false if all items have been
     *         returned
     */
    public...
    ...
    /**
     * Get the next item of the deque. Requires: hasNext() returns true. Modifies:
     * this iterator to advance it to the item following the returned item.
     * 
